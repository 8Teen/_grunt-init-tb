(function(a) {
    ...
    if (typeof define === "function") {
        define("#less/1.3.0/less", [], a)
    } else {
        a(null, null, null, window)
    }
    ...
    less.Parser = function Parser(env) {
        var input, i, j, temp, memo, furthest, chunks, current, parser;
        var that = this;
        var finish = function() {};
        ...
        return parser = {
            ...
            parsers: {
                        ...
                        if (match = $(/^([#.](?:[\w-]|\\(?:[a-fA-F0-9]{1,6} ?|[^a-fA-F0-9]))+)\s*\(/)) {
                            ...
                            do {
                                if (input.charAt(i) === "." && $(/^\.{3}/)) {
                                    ...
                                    if (param = $(this.entities.variable) || $(this.entities.literal) || $(this.entities.keyword)) {
                ...
                element: function() {
                    var e, t, c, v;
                    c = $(this.combinator);
                    e = $(/^(?:\d+\.\d+|\d+)%/) || $(/^(?:[.#]?|:*)(?:[\w-]|\\(?:[a-fA-F0-9]{1,6} ?|[^a-fA-F0-9]))+/) || $("*") || $(this.attribute) || $(/^\([^)@]+\)/);
                    if (!e) {
                ...
                directive: function() {
                    ...
                    if (value = $(this["import"]) || $(this.media)) {
                        ...
                        if (name = $(/^@page|@keyframes/) || $(/^@(?:-webkit-|-moz-|-o-|-ms-)[a-z0-9-]+/)) {
                            types = ($(/^[^{]+/) || "").trim();
                            if (rules = $(this.block)) {
    ...
    (function(tree) {
                    ...
                    if ((mixins = env.frames[i].find(this.selector)).length > 0) {
                        ...
                        for (var m = 0; m < mixins.length; m++) {
                            if (mixins[m].match(args, env)) {
                                try {
                                    Array.prototype.push.apply(rules, mixins[m].eval(env, this.arguments, this.important).rules);
                                    match = true
                                } catch (e) {
                                    throw {
                                        message: e.message,
        ...
        tree.mixin.Definition.prototype = {
            ...
            eval: function(env, args, important) {
                ...
                rules = important ? this.rules.map(function(r) {
    ...
    function error(e, href) {
        ...
        content = "<h3>" + (e.message || "There is an error in your .less file") + '</h3><p>in <a href="' + filename + '">' + filename + "</a> ";
